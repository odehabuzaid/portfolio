      ...
      <>
        {projectsData.map((element) => (
          <Col lg='4' className="mb-3">
            ...
            <img src={element.imgSrc} alt={element.projectTitle}  style={{ minWidth: "100%" }}/>
              <CardBody className='py-5'>
                <h6 className='text-primary text-uppercase'>{element.projectTitle}</h6>
                <p className='description mt-3'>{element.projectDescription} </p>
                <div>
